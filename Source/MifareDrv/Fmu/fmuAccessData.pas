...
begin
  ...
  try
    ...
    fm.Caption := Format('Блок данных %d', [BlockNumber]);
    fm.UpdatePage(Mode);
...
begin
  ...
  Grid.ColCount := 8;
  //
  AddRow(['C1', 'C2', 'C3', 'чтение', 'запись', 'инкремент', 'декремент', 'Описание']);
  AddRow(['0', '0', '0', KeyAB, KeyAB, KeyAB, KeyAB, 'значение по умолчанию']);
