...
type
   ...
   TSCardListCardsA = function (hContext: LongInt; pbAtr: PByte; rgguidInterfaces: PGUID;
                                cguidInterfaceCount: LongInt; mszCards: LPStr; var pcchCards: LongInt): LongInt; stdcall;
   TSCardListCardsW = function (hContext: LongInt; pbAtr: PByte; rgguidInterfaces: PGUID;
...
{$ELSE}
   ...
   function SCardListCardsA(hContext: LongInt; pbAtr: PByte; rgguidInterfaces: PGUID;
                            cguidInterfaceCount: LongInt; mszCards: LPStr; var pcchCards: LongInt): LongInt; stdcall;
   {$EXTERNALSYM SCardListCardsA}
   function SCardListCardsW(hContext: LongInt; var pbAtr: Byte; rgguidInterfaces: PGUID;
                            cguidInterfaceCount: LongInt; mszCards: LPWStr; var pcchCards: LongInt): LongInt; stdcall;
...
{$IFDEF WinSCard_DYNLINK}
type
   TSCardFreeMemory = function (hContext: LongInt; pvMem: Pointer): LongInt; stdcall;

   TSCardAccessStartedEvent = function: LongInt; stdcall;

   TSCardReleaseStartedEvent = function: LongInt; stdcall;
{$ELSE}
   function SCardFreeMemory(hContext: LongInt; pvMem: Pointer): LongInt; stdcall;
...
type
   ...
   TSCardGetStatusChangeA = function (hContext: LongInt; dwTimeout: LongInt; rgReaderStates: PSCARD_READERSTATEA;
                                      cReaders: LongInt): LongInt; stdcall;
   TSCardGetStatusChangeW = function (hContext: LongInt; dwTimeout: LongInt; rgReaderStates: PSCARD_READERSTATEW;
                                      cReaders: LongInt): LongInt; stdcall;
   {$IFDEF UNICODE}
...
{$ELSE}
   ...
   function SCardGetStatusChangeA(hContext: LongInt; dwTimeout: LongInt; rgReaderStates: PSCARD_READERSTATEA;
                                  cReaders: LongInt): LongInt; stdcall;
   {$EXTERNALSYM SCardGetStatusChangeA}
   function SCardGetStatusChangeW(hContext: LongInt; dwTimeout: LongInt; rgReaderStates: PSCARD_READERSTATEW;
                                  cReaders: LongInt): LongInt; stdcall;
...
{$IFDEF WinSCard_DYNLINK}
type
   TSCardControl = function (hCard: LongInt; dwControlCode: LongInt; pvInBuffer: PByte; cbInBufferSize: LongInt;
                             pvOutBuffer: PByte; cbOutBufferSize: LongInt;
...
{$ELSE}
   function SCardControl(hCard: LongInt; dwControlCode: LongInt; pvInBuffer: PByte; cbInBufferSize: LongInt;
                         pvOutBuffer: PByte; cbOutBufferSize: LongInt;
                         var pcbBytesReturned: LongInt): LongInt; stdcall;
...
{$IFDEF WinSCard_DYNLINK}
initialization
  ODS('WinSCard.initialization');
  bPCSCLoaded := PCSCLoadDLL;

finalization
  ODS('WinSCard.finalization.0');
   PCSCUnloadDll;
  ODS('WinSCard.finalization.1');
{$ENDIF}
